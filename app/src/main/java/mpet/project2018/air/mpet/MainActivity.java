...
import izbornik.Početna;
import izbornik.Početna_neulogirani;
...
public class MainActivity extends AppCompatActivity
        ...
        implements
        Početna.OnFragmentInteractionListener,
        Početna_neulogirani.OnFragmentInteractionListener,
        NavigationView.OnNavigationItemSelectedListener
{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ft.replace(R.id.mainFrame, new Početna());
        ft.commit();
//---------------------------------------------------------------
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_frag1) {
            ...
            fragment = new Početna_neulogirani();
        }       //Promjena fragmenta
        if (fragment != null) {
